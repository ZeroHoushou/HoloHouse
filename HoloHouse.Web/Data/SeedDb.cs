...
namespace HoloHouse.Web.Data
{
    public class SeedDb
    {
        ...
        private async Task CheckLesseesAsync()
        {
            ...
            {
                AddLessee("876543", "Rafael", "Bojorquez", "234 3232", "310 322 3221", "Calle Huandooy Calle Huasta");
                AddLessee("654565", "Emi", "Sandoval", "343 3226", "300 322 3221", "Calle 77 #22 21");
                AddLessee("214231", "Fer", "Bojorquez", "450 4332", "350 322 3221", "Carrera 56 #22 21");
                await _context.SaveChangesAsync();
            }
        }
        ...
        private async Task CheckOwnersAsync()
        {
            ...
            {
                AddOwner("8989898", "Anthony", "Sandoval", "234 3232", "310 322 3221", "Calle Luna Calle Sol");
                AddOwner("7655544", "Edwin", "Aguilar", "343 3226", "300 322 3221", "Calle 77 #22 21");
                AddOwner("6565555", "Erick", "Palomino", "450 4332", "350 322 3221", "Carrera 56 #22 21");
                await _context.SaveChangesAsync();
            }
        }
